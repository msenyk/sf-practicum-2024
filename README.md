...
<h2>Apex Trigger</h2>
   ...
   <code>
    ...
    В репозиторії проекту ви знайдете трохи складніший приклад реалізації паттерну для створення Apex Trigger. Спробуйте його розібрати і використовувати як приклад для створення власних Apex Trigger.
